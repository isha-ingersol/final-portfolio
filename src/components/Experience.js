  ...
  const experiences = [
    {
      ...
      skills: ["Python", "Artificial Intelligence", "Chatbot training and testing", "GPT", "LLM", "RAG", "Generative Models", "Backend Engineer"],
    ...
    },
    {
      ...
      skills: ["JavaScript", "TypeScript", "Material UI", "User Interface (UI)", "User Experience (UX)", "Front-end Web Development",],
      link: "https://www.blackngreen.com/",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      skills: ["Leadership", "Microsoft Excel", "Event Organisation", "Sponsorship Management", "Finance Management"],
    ...
    },
    {
      ...
      skills: ["Computer Science", "Scratch", "Teaching", "Podcast Creation", "Video Editing", "Game-based teaching and learning"],
      link: TeachingReport,
    },
    // {
    //   id: 6,
